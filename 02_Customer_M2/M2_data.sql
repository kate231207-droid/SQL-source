...
BEGIN
  ...
  EXECUTE IMMEDIATE 'DROP TABLE email_campaign';
EXCEPTION
  WHEN OTHERS THEN
...
CREATE TABLE Email_Campaign (
    freq_id             NUMBER  primary key,
    freq_description    VARCHAR(20) NOT NULL
);
...
CREATE TABLE customers (
  ...
  email_freq            NUMBER          NULL references email_campaign(freq_id)
);
...
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(1, 'allan.sherwood@yahoo.com', '650215acec746f0e32bdfff387439eefc1358737', 'Allan', 'Sherwood', 1, 2,NULL);
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(2, 'barryz@gmail.com', '3f563468d42a448cb1e56924529f6e7bbe529cc7', 'Barry', 'Zimmer', 3, 3,1);
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(3, 'christineb@solarone.com', 'ed19f5c0833094026a2f1e9e6f08a35d26037066', 'Christine', 'Brown', 4, 4,NULL);
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(4, 'david.goldstein@hotmail.com', 'b444ac06613fc8d63795be9ad0beaf55011936ac', 'David', 'Goldstein', 5, 6,3);
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(5, 'erinv@gmail.com', '109f4b3c50d7b0df729d299bc6f8e9ef9066971f', 'Erin', 'Valentino', 7, 7,3);
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(6, 'frankwilson@sbcglobal.net', '3ebfa301dc59196f18593c45e519287a23297589', 'Frank Lee', 'Wilson', 8, 8,NULL);
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(7, 'gary_hernandez@yahoo.com', '1ff2b3704aede04eecb51e50ca698efd50a1379b', 'Gary', 'Hernandez', 9, 10,1);
INSERT INTO customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id, email_freq) VALUES
(8, 'heatheresway@mac.com', '911ddc3b8f9a13b5499b6bc4638a2b4f3f68bf23', 'Heather', 'Esway', 11, 12,NULL);
